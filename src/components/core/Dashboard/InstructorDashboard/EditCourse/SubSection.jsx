...
const SubSection = ({setEditCourse}) => {
    const {
        register,
        handleSubmit,
        setValue,
    ...
    useEffect(() => {
        console.log("course in step 3 -> ", course);
        ...
        <div className='h-auto flex flex-col '>
            ...
            <form
                ...
                <div className='flex flex-col z-10 h-auto  '>
                    ...
                    >
                        <option value="" disabled="" className='text-black '> Choose a chapter</option>
...

                        {
                            ...
                            sections?.map((section, index) => (
                                ...
                                <option key={index} value={section?._id} className=' text-white h-auto' >
                                    {
                                        section?.sectionName
                                    }
